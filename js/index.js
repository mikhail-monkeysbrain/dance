...
var baton = document.querySelector('#Band #Baton');
var drumstick = document.querySelector('#Band #DrumStick');
var bandleader = document.querySelector('#Band #BandMajor');


setInterval(function(){ 

svgClassFix.toggleClass(baton, 'BatonSpin' , 'StopDrumstick');
